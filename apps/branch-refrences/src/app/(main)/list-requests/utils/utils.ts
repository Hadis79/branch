...
import { DateRangeID, DepositType, Statuses } from './consts';
...
export const isInternalWithdrawal = (value: string): boolean | undefined => {
  if (value === DepositType.ALL || !value) {
    return undefined;
  } else {
    return value === DepositType.ACCOUNT_WITHDRAWAL;
  }
};
