...
import { Box, Button, Dragger, Select } from '@branch-services/ui-kit';
import { useTr } from '@branch-services/translation';

import BatchPaymentSvg from '../../assets/media/batch-payment.svg';
import PaymentTypeSvg from '../../assets/media/payment-type.svg';
...
const UploadFile = () => {
  ...
  const nextStep = () => {
    ...
    if (
      typeof uploadResponse?.totalAmount === 'number' &&
      (formValues?.availableBalance ?? 0) < uploadResponse.totalAmount
    ) {
            ...
            <S.UploadFileContainer fileRequiredError={fileRequiredError}>
              <Form.Item name='file' className='dragger-style'>
                <Dragger
                  ...
                  disabled={uploadFileLoading || !formValues.accountNumber}
