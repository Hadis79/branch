...
import { DateRangeID, TransactionType } from '../../utils/consts';
...
import useBankUnitsQuery from '../../queries/use-get-bank-units-query';

export const Filter = () => {
  const [t] = useTr();
  const [form] = Form.useForm();
  const [isFilterActive, setIsFilterActive] = useState<boolean>(false);
  const { applyFilter, filter, resetMessage, resetDownloadErrorMessage } = useOperationsRequestsHistoryStore();
