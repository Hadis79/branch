...
import { getOperationHistoryQueryKey } from '../utils/consts';
...
const useFilterQuery = () => {
  const { filter, pagination, setMessage, resetMessage } = useOperationsRequestsHistoryStore();
  const { data, error, isLoading, isFetching, isError, refetch, isPlaceholderData } = useQuery({
    queryKey: getOperationHistoryQueryKey(filter, pagination),
