...
const getAccountsNumber = async (legalId: string | null, accountNumber?: string): Promise<any> => {
  return await Api.getAccounts(legalId, accountNumber);
};

const useAccountsQuery = (legalId: string | null, accountNumber: string) => {
